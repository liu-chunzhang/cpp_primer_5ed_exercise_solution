...
Bear::Bear( std::string name , bool onExhibit , std::string family ) : ZooAnimal( name , onExhibit , family ) , dancetype( two_left_feet ) { }
...
double Panda::max_weight() const {
    return std::max( ZooAnimal::max_weight() , Endangered::max_weight() ) ;     // ±ÜÃâ¶şÒåĞÔ
}
