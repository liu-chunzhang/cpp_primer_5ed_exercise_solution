...
String &String::operator = ( const String &Str ){
    ...
    p = newp ;
    sz = Str.size() ;
    cout << "应用拷贝赋值运算符String &String::operator = ( const String &Str )" << endl;
    return *this ;
}
...
String &String::operator = ( String &&s ) noexcept {
    ...
    cout << "应用移动赋值运算符String &String::operator = ( String &&s ) noexcept" << endl;
    return *this ;
}
...
String &String::operator = ( char c ){
    ...
    p = alloc.allocate( sz ) ;
    *p = c ;
    cout << "应用赋值运算符String &String::operator = ( char c )" << endl;
    return *this ;
}
...
String &String::operator = ( const char *cp ){
    ...
    p = alloc.allocate( sz ) ;
    uninitialized_copy( cp , cp + sz , p ) ;
    cout << "应用赋值运算符String &String::operator = ( const char *cp )" << endl;
    return *this ;
}
...
String &String::operator = ( initializer_list<char> clst ){
    ...
    cout << "应用赋值运算符String &String::operator = ( initializer_list<char> clst )" << endl;
    return *this ;
}
...
String::~String() noexcept {
    ...
    cout << "应用析构函数String::~String() noexcept" << endl;
};
