...
Sales_data::Sales_data( Sales_data &&rhs ) : bookNo( std::move( rhs.bookNo ) ) , units_sold( std::move( rhs.units_sold ) ) , sellingprice( std::move( rhs.sellingprice ) ) , saleprice( std::move( rhs.saleprice ) ) , discount( std::move( rhs.discount ) ) {
    rhs.bookNo.~string() ;
}
...
Sales_data &Sales_data::operator = ( Sales_data &&rhs ) {
    if( this != &rhs ){
        ...
        sellingprice = std::move( rhs.sellingprice ) ;
        saleprice = std::move( rhs.saleprice ) ;
